...
func (m *MockStorageClient) GetStorageSpace(region string) (*StorageSpace, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStorageSpace", region)
...
func (mr *MockStorageClientMockRecorder) GetStorageSpace(region interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStorageSpace", reflect.TypeOf((*MockStorageClient)(nil).GetStorageSpace), region)
}

// ListNetworkTraffics mocks base method
func (m *MockStorageClient) ListNetworkTraffics(backwardTo int, region string) (*ListTrafficResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNetworkTraffics", backwardTo, region)
...
func (mr *MockStorageClientMockRecorder) ListNetworkTraffics(backwardTo, region interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListNetworkTraffics", reflect.TypeOf((*MockStorageClient)(nil).ListNetworkTraffics), backwardTo, region)
}

// GetNetworkTraffic mocks base method
func (m *MockStorageClient) GetNetworkTraffic(date, region string) (*DownTraffic, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNetworkTraffic", date, region)
...
func (mr *MockStorageClientMockRecorder) GetNetworkTraffic(date, region interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNetworkTraffic", reflect.TypeOf((*MockStorageClient)(nil).GetNetworkTraffic), date, region)
}

// GetRegions mocks base method
func (m *MockStorageClient) GetRegions() (*Regions, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRegions")
	ret0, _ := ret[0].(*Regions)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRegions indicates an expected call of GetRegions
func (mr *MockStorageClientMockRecorder) GetRegions() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRegions", reflect.TypeOf((*MockStorageClient)(nil).GetRegions))
}
...
// SelectRegionPutBucket mocks base method
func (m *MockStorageClient) SelectRegionPutBucket(bucket, region string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelectRegionPutBucket", bucket, region)
	ret0, _ := ret[0].(error)
	return ret0
}

// SelectRegionPutBucket indicates an expected call of SelectRegionPutBucket
func (mr *MockStorageClientMockRecorder) SelectRegionPutBucket(bucket, region interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStorageClient) DoesBucketExist(bucket string) (bool, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageClient) DoesObjectExist(bucket, key string) (bool, string, error) {
	m.ctrl.T.Helper()
